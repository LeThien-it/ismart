                            ...
                            <thead>
                                <tr>
                                    ...
                                    @else
                                        ...
                                        @canany(['update', 'delete'], App\Slider::class)
                                    ...
                                    @foreach ($sliders as $slider)
                                        @can('view', $slider)
                                            <tr>
                                                ...
                                                @else
                                                    <td>
                                                        <a class="{{ $slider->getStatus()['class'] }}"
                                                            href="{{ Auth::user()->checkPermissionAccess('edit_slider') ? route('slider.status', ['id' => $slider->id]) : '' }}">
                                                            {{ $slider->getStatus()['name'] }}
                                                        </a>
                                                    </td>
                                                    @canany(['update', 'delete'], $slider)
                                                        <td>
                                                            @can('update', $slider)
